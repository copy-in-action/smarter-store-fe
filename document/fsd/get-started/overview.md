...
**Warning**: Layers App and Shared, unlike other layers, do not have slices and are divided into segments directly.
...
4.  It's advised to refrain from adding new large entities while refactoring or refactoring only certain parts of the project.

### Next steps

Want to get a good grasp of how to think in FSD? Check out the Tutorial. Prefer to learn from examples? We have a lot in the Examples section. Have questions? Drop by our Telegram chat and get help from the community.
