 ...
 */
export interface SeatChartConfig extends StaticSeatVenue, BookingStatus, UserSeatSelection {
  /** 차트 모드 */
  mode: SeatChartMode;
}
 ...
 * 좌석 상태 타입
 */
export type SeatStatus = "available" | "selected" | "reserved" | "pending" | "disabled";